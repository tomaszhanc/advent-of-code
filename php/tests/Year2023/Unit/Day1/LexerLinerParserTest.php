...
{
    #[Test] #[DataProvider('lines_integers_only')]
    public function it_parses_lines_of_integers_only(string $line, Line $expectedLine): void
    {
    ...
    #[Test] #[DataProvider('lines_integers_and_spelled_out_digits')]
    public function it_parses_lines_of_integers_and_spelled_out_digits(string $line, Line $expectedLine): void
    {
