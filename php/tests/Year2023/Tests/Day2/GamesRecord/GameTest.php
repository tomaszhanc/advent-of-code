...
final class GameTest extends TestCase
{
     ...
     */
    public function test_determines_if_it_can_be_played_out_with_a_given_cubes_set(Game $game, CubesSet $cubesSet, bool $canBePlayedOut): void
    {
     ...
     */
    public function test_finds_the_smallest_cube_set_required_to_play_the_game(Game $game, CubesSet $expectedSmallestCubeSet): void
    {
