...
{
    public function test_allows_only_single_digit_integers(): void
    {
    ...
    public function test_allows_only_single_spelled_out_digits(): void
    {
     ...
     * @dataProvider digits
     */
    public function test_creates_a_digit(string|int $input, Digit $expectedDigit): void
    {
