...
final class PuzzleSolverTest extends TestCase
{
    ...
    public function it_sum_all_lines_calibration_values(): void
    {
        ...
        $input = new InMemoryInput('zoneight234', 'a1b2c3d4e5f');

        $this->assertSame(24 + 15, $solver->sumAllCalibrationValuesFrom($input));
    }
    ...
    public function it_solves_day_1_part_1_sum_of_all_calibration_values_built_from_numeric_digits_only(): void
    {
        ...
        $this->assertEquals(54597, $solver->sumAllCalibrationValuesFrom(PuzzleInputs::day1_calibrationDocument()));
    }
    ...
    public function it_solves_day_1_part_2_sum_of_all_calibration_values_built_from_numeric_and_word_digits(): void
    {
        ...
        $this->assertEquals(54504, $solver->sumAllCalibrationValuesFrom(PuzzleInputs::day1_calibrationDocument()));
    }
}
