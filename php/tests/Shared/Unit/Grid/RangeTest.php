...
{
    #[Test]
    public function start_column_must_be_less_than_equal_end_column(): void
    {
        $this->expectExceptionMessage('start cell column must be less than or equal');
    ...
    #[Test]
    public function diagonal_ranges_are_not_supported(): void
    {
        $this->expectExceptionMessage('Diagonal lines are not supported');
    ...
    public function it_is_adjacent(Line $range, Cell $point, bool $isAdjacent): void
    {
