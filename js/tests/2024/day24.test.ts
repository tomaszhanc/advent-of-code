...
import {part1, part2} from "../../src/2024/day24/day24";
...
tnw OR pbm -> gnj
`;
const input = readPuzzleInput('2024/day24.txt');

describe('AoC 2024, Day 24, Part 1', () => {
    it('checks the example 1', () => {
        expect(part1(example1)).toBe(4)
    })
    it('checks the example 2', () => {
        expect(part1(example2)).toBe(2024)
    })

    it('check the input', () => {
        expect(part1(input)).toBe(42410633905894)
    })
});
